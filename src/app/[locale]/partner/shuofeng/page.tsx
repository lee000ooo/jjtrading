...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.jjtrading.com.cn/${locale}/partner/shuofeng`,
      languages: {
        ru: "https://www.jjtrading.com.cn/ru/partner/shuofeng",
        en: "https://www.jjtrading.com.cn/en/partner/shuofeng",
        zh: "https://www.jjtrading.com.cn/zh/partner/shuofeng",
      },
    },
    openGraph: {
      ...
      url: `https://www.jjtrading.com.cn/${locale}/partner/shuofeng`,
    },
  };
}

export default async function ShuofengPage({ params }: Props) {
  const { locale } = await params;
